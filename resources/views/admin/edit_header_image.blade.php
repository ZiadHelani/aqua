        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          ...
          @endif
            <div class="card">
                ...
                <div class="card-body">
                    <img style="object-fit: cover" width="300px" height="200px" src="{{asset('images/home-header/' . $image->image)}}" alt="">
                    <form action="{{route('save_header_image', $image->id)}}"  method="POST" enctype="multipart/form-data">
                        @csrf
